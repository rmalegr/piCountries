		...
		<div className={style.background}>
			...
			<div className={style.filters}>
				<div className={style.filter}>
					<select className={style.filtro} onChange={handleOrderPopulation}>
				...
				<div className={style.filter}>
					<select className={style.filtro} onChange={handleContinents}>
				...
				<div className={style.filter}>
					<select className={style.filtro} onChange={handleActivity}>
						{" "}
